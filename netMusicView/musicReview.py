...
class music:
    ...
    def get_json(self, url, params, encSecKey):
        ...
        self.response = urllib.request.urlopen(self.request,context=context)
    ...
    def get_hotcomments(self, url):
        ...
        f = open('/Users/xulei2/Desktop/HotComments.txt', 'w', encoding='utf-8')
    ...
    def get_allcomments(self, url):
        ...
        f = open('/Users/xulei2/Desktop/AllComments.txt', 'w', encoding='utf-8')
        present_page = 0
...
# https://music.163.com/weapi/v1/resource/comments/R_SO_4_472117541?csrf_token=
# mail.get_hotcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_227323?csrf_token")
mail.get_allcomments("https://music.163.com/weapi/v1/resource/comments/R_SO_4_472117541?csrf_token")
